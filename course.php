...
<!-- //breadcrum -->
<section class="w3l-services2 fade-start fade-end" id="courceDetailSection" style='background: url(./assets/images/aims-delhi-bg1.jpg) no-repeat 0px 0px;background-size: cover;background-position: center;position: relative;z-index: 1;'>
  <div class="mobile-info-not py-5" style='background-size: cover;'>
    <div class="container py-lg-3">
      ...
      <div class="row mobile-info-inn mx-lg-0">
        <div class="col-lg-6 mobile-right">
			<a href="course-jee-advanced.php">
			  <div class="row mobile-right-grids mb-lg-5 mb-4 ripplecontainer" data-type='detailTrigger' data-href='#jeeAdvanceDetail'>
				...
				<div class="col-md-10 col-lg-9 mobile-right-info col-9">
				  <h6><a href="course-jee-advanced.php" style='color: #8f2929;'>Batch Arjuna : Jee Advanced</a></h6>
				  <div style='color:#616161'>
					  <b>For the unstoppable ones</b>
					  <div>4+1+1 Week Program</div>
				  </div>
			...
			<a href="course-neet.php">
			  <div class="row mobile-right-grids mb-lg-5 mb-4 ripplecontainer" data-type='detailTrigger' data-href='#neetDetail'>
				...
				<div class="col-md-10 col-lg-9 mobile-right-info col-9">
				  <h6><a href="course-neet.php" style='color: #8f2929;'>Batch Ankur : NEET</a></h6>
				  <div style='color:#616161'>
					  <b>For the building medicos</b>
					  <div>5+1+1 Week Program</div>
				  </div>
			...
			<a href="course-jee-main.php">
			  <div class="row mobile-right-grids mb-lg-5 mb-4 ripplecontainer" data-type='detailTrigger' data-href='#jeeMainsDetail'>
				<div class="col-md-2 col-lg-3 pr-0 col-3 mobile-right-icon">
				  <div class="mobile-icon ripple">
				...
				<div class="col-md-10 col-lg-9 mobile-right-info col-9">
				  <h6><a href="course-jee-main.php" style='color: #8f2929;'>Batch Abhimanyt : JEE Main</a></h6>
				  <div style='color:#616161'>
					  <b>For the unbeatable ones</b>
					  <div>5+1+1 Week Program</div>
				  </div>
			...
			<a href="course-foundation-courses.php">
			  <div class="row mobile-right-grids mb-lg-5 mb-4 ripplecontainer"  data-type='detailTrigger' data-href='#foundationDetail'>
				...
				<div class="col-md-10 col-lg-9 mobile-right-info col-9">
				  <h6><a href="course-foundation-courses.php" style='color: #8f2929;'>Batch Agrim : Foundation</a></h6>
				  <div style='color:#616161'>
					  <b>For early learners (8<sup>th</sup> & 9<sup>th</sup> Std. Only)</b>
					  <div>Every Sunday</div>
				  </div>
				  <!--p>A one-year intensive course to prepare for JEE, NEET, and other scholarship exams. Students interested will be placed in <span style='color:#8f2929;font-weight:bold;'>BATCH AGRIM</span>. It is a weekly program.</p-->
				</div>
			  </div>
			</a>
        </div>
        <!--div class="col-lg-4 mobile-left" style='display:none;'>
        ...
        <div class="col-lg-6 mobile-right">
			...
			<a href="#url">
			  <div class="row mobile-right-grids mb-lg-5 mb-4 ripplecontainer"  data-type='detailTrigger' data-href='#foundationDetail'>
				...
				<div class="col-md-10 col-lg-9 mobile-right-info col-9">
				  <h6><a href="#url" style='color: #8f2929;'>Batch Aarambh : 1 + Batch</a></h6>
				  <div style='color:#616161'>
					  <b>For the visionaries</b>
					  <div>1 Year &nbsp;: Every Sundad till September</div>
					  <div>2 Years : 4+1+1 Week Program</div>
				  </div>
				  <!--p>A one-year intensive course to prepare for JEE, NEET, and other scholarship exams. Students interested will be placed in <span style='color:#8f2929;font-weight:bold;'>BATCH AGRIM</span>. It is a weekly program.</p-->
				</div>
			  </div>
			...
			<a href="#url">
			  <div class="row mobile-right-grids mb-lg-5 mb-4 ripplecontainer"  data-type='detailTrigger' data-href='#foundationDetail'>
				...
				<div class="col-md-10 col-lg-9 mobile-right-info col-9">
				  <h6><a href="#url" style='color: #8f2929;'>Batch Anubhav : Target Batch</a></h6>
				  <div style='color:#616161'>
					  <b>For experienced learners</b>
					  <div>6+1 Week Program</div>
				  </div>
				  <!--p>A one-year intensive course to prepare for JEE, NEET, and other scholarship exams. Students interested will be placed in <span style='color:#8f2929;font-weight:bold;'>BATCH AGRIM</span>. It is a weekly program.</p-->
				</div>
			  </div>
			...
			<a href="course-prayas-aits.php">
			  <div class="row mobile-right-grids mb-lg-5 mb-4 ripplecontainer"  data-type='detailTrigger' data-href='#prayasDetail'>
				...
				<div class="col-md-10 col-lg-9 mobile-right-info col-9">
				  <h6><a href="course-prayas-aits.php" style='color: #8f2929;'>PRAYAS-AITS</a></h6>
				  <p>A national level test series for students to rank themselves amongst the best of India.</p>
				</div>
			  </div>
			</a>
			<a href="course-kvpy-olymoiads.php">
			  <div class="row mobile-right-grids mb-lg-5 mb-4 ripplecontainer"  data-type='detailTrigger' data-href='#kvpyDetail'>
				<div class="col-md-2 col-lg-3 pr-0 col-3 mobile-right-icon">
				  <div class="mobile-icon ripple">
					<img src="assets/images/banner.jpg" class="img-fluid" alt="" />
				  </div>
				...
				<div class="col-md-10 col-lg-9 mobile-right-info col-9">
				  <h6><a href="course-kvpy-olymoiads.php" style='color: #8f2929;'>KVPY & OLYMPIADS</a></h6>
